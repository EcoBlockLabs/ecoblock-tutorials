...
`greeter` is a simple demo of EcoBlock's L1-to-L2 message passing system (aka "retryable tickets").
...
The script and contracts demonstrate how to interact with EcoBlock's core bridge contracts to create these retryable messages, how to calculate and forward appropriate fees from L1 to L2, and how to use EcoBlock's L1-to-L2 message [address aliasing](https://developer.offchainlabs.com/docs/l1_l2_messages#address-aliasing).
